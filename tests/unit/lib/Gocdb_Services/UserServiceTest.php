...
class UserServiceTest extends PHPUnit_Extensions_Database_TestCase {
  ...
  */
  ...
  private function getUserData () {
    ...
    $userData = array (
      ...
      'CERTIFICATE_DN' => '/CN=Forename Surname'
    );

    return $userData;
  }
  private function createAndRegisterUser ($userData) {
  ...
  */
  public function testRegisterUser() {
    ...
    $userService = $this->createAndRegisterUser($userData);

    $user = $userService->getUserByPrinciple($userData['CERTIFICATE_DN']);
  ...
  public function testAddAPIAuthentication () {
    ...
    $authEnt->setIdentifier($userData['CERTIFICATE_DN']);
